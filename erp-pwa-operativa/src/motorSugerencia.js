...
//
// Duplicado a propósito en erp-web/src/utils/motorSugerencia.js: este proyecto no tiene
// tooling de monorepo/paquete compartido entre erp-web y las PWA (ver CLAUDE.md) — mismo
// criterio ya usado para los tokens de diseño (tokens.css). Si se corrige un bug acá,
