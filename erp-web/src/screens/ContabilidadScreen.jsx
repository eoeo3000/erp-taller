...
export default function ContabilidadScreen({ API }) {
    ...
    const fetchCuentas = useCallback(async () => {
        try {
            const r = await fetch(`${API}/contabilidad/cuentas`, { headers: { ...headerEntorno(), ...headerApiKey(), ...headerSesion() } });
    ...
    const fetchAsientos = useCallback(async () => {
        ...
        try {
            const r = await fetch(`${API}/contabilidad/asientos?${params}`, { headers: { ...headerEntorno(), ...headerApiKey(), ...headerSesion() } });
            const d = await r.json();
    ...
    const guardarCuenta = async () => {
        ...
        try {
            ...
            const r = await fetch(url, { method, headers: { 'Content-Type': 'application/json', ...{ ...headerEntorno(), ...headerApiKey(), ...headerSesion() } }, body: JSON.stringify(formCuenta) });
            const d = await r.json();
    ...
    const eliminarCuenta = async (id) => {
        ...
        const r = await fetch(`${API}/contabilidad/cuentas/${id}`, { method: 'DELETE', headers: { ...headerEntorno(), ...headerApiKey(), ...headerSesion() } });
        const d = await r.json();
    ...
    const fetchMayor = async () => {
        ...
        try {
            const r = await fetch(`${API}/contabilidad/mayor/${mayorCuentaId}?${params}`, { headers: { ...headerEntorno(), ...headerApiKey(), ...headerSesion() } });
            const d = await r.json();
